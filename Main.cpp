...
static const int VARIABLE_LIST_SIZE = 23; // current number of symptoms
...
std::string conclusionList[30][2] = { {"Not Sick", "-1"}, {"Sick", "-1"}, {"Asprin", "-1"},
                                        {"Benzodiazepines", "-1"}, {"Alcohol", "-1"}, {"Poison Induced Pain", "-1"},
                                        {"Iodine", "-1"}, {"Stimulant", "-1"}, {"Non-Pain Inducing Poison", "-1"},
                                        {"Opioids", "-1"}, {"Painkillers", "-1"}, {"Rat Poison", "-1"},
                                        {"Patient Possibly Envenomed", "-1"}, {"Spider Bite", "-1"}, {"Iron Poisoning", "-1"},
                                        {"Herbicide", "-1"}, {"Snake Bite", "-1"}, {"Possible Medical Drug Abuse", "-1"},
                                        {"Cannabis", "-1"}, {"Anti Depressants", "-1"}, {"Paracetamol", "-1"},
                                        {"Likely Ingested Substance", "-1"}, {"Inhalent Abuse", "-1"}, {"Fumigants", "-1"},
                                        {"Mushrooms", "-1"}, {"Non Muscle Related", "-1"}, {"Calcium", "-1"},
                                        {"lead", "-1"}, {"Carbon Monoxide", "-1"}, {"Arsenic", "-1"}};
...
std::string ifThenList[30][5] = { {"Sick", "-1", "-1", "-1", "No"}, // if not sick, then poison = no
                                    ...
                                    {"Poison Induced Pain", "Dizzyness", "-1", "-1", "Stimulant"}, // 8
